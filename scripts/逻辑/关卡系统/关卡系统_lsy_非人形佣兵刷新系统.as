...
{
	var 佣兵数据 = _root.可雇佣敌人列表[random(可雇佣敌人列表.length)];
...
_root.创建可雇用敌人实体对象 = function(佣兵数据, X, Y)
{
	...
	佣兵对象.默认对话[0][0] = [佣兵数据.名字, 佣兵数据.身份, "盗贼", 随机对话内容, "佣兵数据.名字"];
...
_root.计算可雇用敌人价格 = function(佣兵对象){
	...
	var 等级增幅 = 50 * 佣兵对象.等级 * 佣兵对象.等级 + 0.02 * 宠物数据.Price * 佣兵对象.等级; //随等级二次增长
...
_root.可雇佣敌人列表 = new Array(7);

_root.可雇佣敌人列表[0] = {兵种:"敌人-盗贼大叔", 名字:"铁拳", 身高:195, 性别:"男", 身份:"游寇", 战宠编号:4};
_root.可雇佣敌人列表[1] = {兵种:"敌人-盗贼侏儒", 名字:"跳蚤", 身高:175, 性别:"男", 身份:"游寇", 战宠编号:5};
_root.可雇佣敌人列表[2] = {兵种:"敌人-盗贼瘦子", 名字:"杀手", 身高:175, 性别:"男", 身份:"游寇", 战宠编号:6};
_root.可雇佣敌人列表[3] = {兵种:"敌人-盗贼枪手", 名字:"左轮", 身高:175, 性别:"男", 身份:"游寇", 战宠编号:80};
_root.可雇佣敌人列表[4] = {兵种:"敌人-狂野玫瑰马尾姑娘", 名字:"街舞少女", 身高:175, 性别:"女", 身份:"狂野玫瑰成员", 战宠编号:7};
_root.可雇佣敌人列表[5] = {兵种:"敌人-辫子姑娘", 名字:"战斗少女", 身高:175, 性别:"女", 身份:"狂野玫瑰成员", 战宠编号:8};
_root.可雇佣敌人列表[6] = {兵种:"敌人-黑铁会死士", 名字:"黑铁死士", 身高:175, 性别:"男", 身份:"黑铁会部众", 战宠编号:9};
